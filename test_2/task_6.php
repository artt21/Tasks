...
$people = [
    ...
    [
        'name' => 'Jovanni (PHP Developer)',
        'position' => 'Programmer',
        'img_src' => 'img/demo/authors/jovanni.png',
        'img_alt' => 'Jovanni D.',
        'twitter' => 'https://twitter.com',
        'twitter_name' => '@jovanni1337',
        'contact' => 'https://wrapbootstrap.com/user/Walapa',
        'contact_text' => 'Jovanni',
        'is_banned' => true,
    ],
    [
        'name' => 'Roberto (Rails Developer)',
        'position' => 'Partner &amp; Contributor',
        'img_src' => 'img/demo/authors/roberto.png',
        'img_alt' => 'Roberto K.',
        'twitter' => 'https://twitter.com',
        'twitter_name' => '@Roberto0o',
        'contact' => 'https://wrapbootstrap.com/user/Walapa',
        'contact_text' => 'Rob',
        'is_banned' => true,
    ],
                ...
                <div class="panel-content">
                    <div class="d-flex flex-wrap demo demo-h-spacing mt-3 mb-3">
                        <?php foreach ($people as $person): ?>
                                <div class="rounded-pill bg-red shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
                                    <img src="<?= $person['img_src']; ?>" alt="<?= $person['img_alt']; ?>"
                                         class="img-thumbnail img-responsive rounded-circle"
                                         style="width:5rem; height: 5rem;">
                                    <div class="ml-2 mr-3">
                                        <h5 class="m-0" style="color:<?= $person['is_banned'] ? "red" : ""?>">
                                            <?= $person['name']; ?>
                                            <small class="m-0 fw-300">
                                                <?= $person['position']; ?>
                                            </small>
                                        </h5>
                                        <a href="<?= $person['twitter']; ?>" class="text-info fs-sm"
                                           target="_blank"><?= $person['twitter_name']; ?></a>
                                        -
                                        <a href="<?= $person['contact']; ?>" class="text-info fs-sm"
                                           target="_blank" title="Contact <?= $person['contact_text']; ?>"><i
